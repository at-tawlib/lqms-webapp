...
const sections = {
  ...
  "Environment Maintenance Record": [
    "#",
    "Date",
    "Unit",
  ...
  "Staffing Need Assessment": ["UNIT", "ROLE", "DESIGNATION", "# REQUIRED", "# ON ROLL", "DEFICIT"],
  "EQA Schedule": ["TEST", "EQA PROVIDER", "FREQUENCY", "ALTERNATIVE"],
  "Equipment Maintenance Schedule": ["MONTH", "EQUIPMENT", "Q", "B", "A"],
  ...
  "QA Meeting": ["Month", "Day", "Venue", "Start Time", "End Time", "Person responsible"],
